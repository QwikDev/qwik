...
`ErrorBoundary` now ships from `@qwik.dev/core` instead of `@qwik.dev/router` — update your imports. The previous Router `ErrorBoundary` was never fully implemented and is removed; this is a new, SSR-capable implementation:
