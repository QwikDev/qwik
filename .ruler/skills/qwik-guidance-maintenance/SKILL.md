...
- Generated outputs (committed): root `AGENTS.md` and root `CLAUDE.md`; generated skill copies in
  `.claude/skills/` and `.codex/skills/` are gitignored, as are other assistant-local files
