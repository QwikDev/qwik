...
test:
	cargo test --manifest-path packages/rust-optimizer/core/Cargo.toml

benchmark:
	cargo bench --manifest-path packages/rust-optimizer/core/Cargo.toml

test-update:
	if ! cargo test --manifest-path packages/rust-optimizer/core/Cargo.toml; then \
		cd packages/rust-optimizer/core/src/snapshots/; \
...
publish-core:
	cd packages/rust-optimizer/core && cargo publish --all-features
