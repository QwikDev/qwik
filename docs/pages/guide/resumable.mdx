---
title: Resumable
fetch: https://hackmd.io/@mhevery/rkYkHhCxq
---
...
The above describes why the current generation of frameworks have an expensive startup which is proportional to the complexity of the application which is being resumed. The more complex the application is, the more expensive the hydration cost, both in terms of the code to download and the code to execute.
