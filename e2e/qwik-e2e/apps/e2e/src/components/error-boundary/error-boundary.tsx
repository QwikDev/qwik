...
export const ErrorBoundaryStreamingRoot = component$(() => {
  ...
  return (
    <main>
      ...
      ) : scenario === 'fallback-nested-resume' ? (
        // Outer child always throws, so its fallback re-derives; the inner boundary
        // lives inside that resumed SSR fallback and its reset must target the outer.
        <ErrorBoundary
          fallback$={(e) => (
