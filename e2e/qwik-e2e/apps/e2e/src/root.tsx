...
// Async computed loses the context provider scope during SSR.
...
// Compiler drops `async` from transformed async components.
...
// Compiler rewrites `worker$` to a missing `worker` export.
...
// Compiler emits a missing symbol for the nested index component.
/*
const TestIndex = component$(() => (
  <section>Test index</section>
));
*/
