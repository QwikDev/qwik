...
import { type DocumentHead, Form, Link, routeAction$, routeLoader$, zod$ } from '@qwik.dev/router';
...
export default component$(() => {
  ...
  return (
    <div class="loaders">
      ...
      <ul>
        <li>
          <Link href="/qwikrouter-test/loaders/stuff/" id="link-stuff">
            To Stuff
          </Link>
        </li>
        <li>
          <Link href="/qwikrouter-test/loaders/redirect/" id="link-redirect">
            To Redirect home
          </Link>
        </li>
        <li>
          <Link href="/qwikrouter-test/loaders/redirect-welcome/" id="link-welcome">
