...
test.describe('lexical-scope', () => {
  ...
  test('should rerender without changes', async ({ page }) => {
    const SNAPSHOT =
      '<p><!--d=3-->1<!--/d--></p><p><!--d=4-->"&lt;/script&gt;"<!--/d--></p><p><!--d=5-->{"a":{"thing":12},"b":"hola","c":123,"d":false,"e":true,"f":null,"h":[1,"string",false,{"hola":1},["hello"]],"promise":{}}<!--/d--></p><p><!--d=6-->undefined<!--/d--></p><p><!--d=7-->null<!--/d--></p><p><!--d=8-->[1,2,"hola",null,{}]<!--/d--></p><p><!--d=9-->true<!--/d--></p><p><!--d=10-->false<!--/d--></p><p><!--d=11-->()=&gt;console.error()<!--/d--></p><p q:id="12">mutable message</p><p><!--d=13-->{"signal":{"value":0},"signalValue":0,"store":{"count":0,"signal":{"value":0}},"storeCount":0,"storeSignal":{"value":0}}<!--/d--></p><p><!--d=14-->from a promise<!--/d--></p><p><!--d=15-->message, message2, signal, signalValue, store, storeCount, storeSignal<!--/d--></p>';
    const RESULT =
