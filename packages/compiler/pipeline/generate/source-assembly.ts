/** Applies compiler-owned edits to authored source with magic-string, composing normalization maps. */
import MagicString, {
...
import { createNodeSourceMap, sourceRelativeToMap } from '../source-maps';
