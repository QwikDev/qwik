...
export default component$(function App() {
  ...
  test('should flatten imported fragments and retain collection keys', async () => {
    await testInput(mode, 'jsx-fragment', {
      code: `import { component$, Fragment, Fragment as F, Slot, useSignal } from '@qwik.dev/core';
...
`,
      },
      {
        path: 'src/app.tsx',
        code: `import { component$ } from '@qwik.dev/core';
import { makeNode, makeFactory } from './helper';
import { Display } from './display';
const sibling = (label) => <u>{label}</u>, App = component$(() => {
...
export default component$(function App() {
  ...
  test('passes JSX values in component props', async () => {
    const output = await testInput(mode, 'jsx-prop', {
      code: `import { component$, useSignal } from '@qwik.dev/core';
import { Display } from './display';
export const Direct = component$(function Direct() { return <Display fallback={<b>ready</b>} />; });
export const Spread = component$(function Spread() {
  const options = useSignal({ title: 'title' });
  return <Display {...options.value} fallback={<b>ready</b>} />;
});
export const Rows = component$(function Rows() {
...
const before = observe('before'), Header = component$(() => <h1>Title</h1>), after = observe('after');
...
export default component$(() => {
  ...
  test('should compile an expression-body arrow component', async () => {
    await testInput(mode, 'expression-body-arrow', {
      code: `import { component$ } from '@qwik.dev/core';
export default component$(() => <p>Hello Qwik</p>);
`,
    });
  });
...
`,
  ...
  test('should render a props text hole inside a branch arm', async () => {
    await testInput(mode, 'branch-arm-props-text', {
      code: `import { component$ } from '@qwik.dev/core';
export default component$((props: { enabled: boolean; label: string }) => {
...
export default component$((props: { label?: string; content?: any }) => {
  ...
  test('should create a dynamic tag inside svg in its namespace', async () => {
    const output = await testInput(mode, 'dynamic-tag-namespace', {
      code: `import { component$ } from '@qwik.dev/core';
export default component$((props: { shape: string }) => (
