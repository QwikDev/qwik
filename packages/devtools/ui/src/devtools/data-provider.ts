 ...
 * - `ExtensionDataProvider`: reads window globals via chrome.devtools.inspectedWindow.eval() (browser
 *   extension)
 */
...
declare global {
  interface Window {
    /**
     * When set before the UI mounts, the devtools will use this provider instead of the default
     * Vite RPC connection.
     */
