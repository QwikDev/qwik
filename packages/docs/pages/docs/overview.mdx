...
- **Progressive**: Qwik takes full responsability of how to load and download JS. No more manual code splitting.
...
- **Scalable**: Qwik application have [O(1)](https://en.wikipedia.org/wiki/Time_complexity#Constant_time) constant scalability. [It does not matter your full application has 1 million components, your app will boot up the same.](https://www.builder.io/blog/our-current-frameworks-are-on-we-need-o1)
