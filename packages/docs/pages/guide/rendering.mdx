...
- For explanation of `$` see [`$` and optimizer rules](./optimizer/dollar.mdx).
- For explanation of `q:host` see [host element](./components/host-element.mdx).
- For explanation of `q:obj` see [serialization](./serialization/overview.mdx).
- For explanation of `onClickQrl` see [qwikloader](./qwikloader.mdx).
