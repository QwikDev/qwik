...
self.onfetch = ev => {
    ...
    if (pathname.endsWith("sw.html")) {
        ev.respondWith(response('<!DOCTYPE html><html><head><meta charset="utf-8"><script type="module" src="./partytown-sandbox-sw.js?v=0.7.0-dev1664407017534"><\/script></head></html>'));
    } else {
