...
(self => {
    ...
    const getPartytownScript = () => `<script src="${partytownLibUrl("partytown.js?v=0.7.0-dev1663948279283")}"><\/script>`;
                    ...
                    if (!hasInitializedMedia) {
                        (() => {
                            if (!webWorkerCtx.$initWindowMedia$) {
                                ...
                                webWorkerCtx.$importScripts$(partytownLibUrl("partytown-media.js?v=0.7.0-dev1663948279283"));
