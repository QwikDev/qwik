...
An alternative way to author content is using `.mdx` files. (Markdown JSX.) These files are authored as Markdown, but they are compiled down to Qwik components. In addition to per Markdown, they can also refer to other components.
