...
Routing is a way to map public URLs for a site to specific components declared in your application. Qwikcity uses a file-based router. This means that the directory/file structure drives the public-facing URLs that the user will see for your application.
