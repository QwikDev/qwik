...
Composing functions would not be very useful you couldn't pass in parameters. In the same way that functions have parameters, components have "props". A component uses props to pass data from parent to child components.
