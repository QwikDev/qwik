...
<Image class="w-full" src={img1} alt="An image of a rocket on a notebook in space." />
...
<Image class="w-full" src={img2} alt="A screenshot of a Discord chat between Misko and Jack." />
...
<Image class="w-full" src={img3} alt="An Illustration of hydration vs resumability." />
...
<video crossorigin="anonymous" muted loop autoplay>
  <source
    src="https://cdn.builder.io/o/assets%2FYJIGb4i01jvw0SRdL5Bt%2F7be046307ece4278a81789e386737813%2Fcompressed?apiKey=YJIGb4i01jvw0SRdL5Bt&token=7be046307ece4278a81789e386737813&alt=media&optimized=true"
    type="video/mp4"
  />
</video>
