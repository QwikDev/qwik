...
[Framer Motion Image Gallery Example](https://codesandbox.io/embed/framer-motion-image-gallery-pqvx3?fontsize=14)
...
(Video of working image gallery)
...
(Video of network tab showing lazy loading)
