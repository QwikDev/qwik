...
<div style='position:relative;padding-bottom:56.25%;height:0;'>
	<iframe
		src='https://qwik-twitter.builder.io/tweet/1625473748777291780'
...
<div style='position:relative;padding-bottom:56.25%;height:0;'>
	<iframe
		src='https://qwik-twitter.builder.io/tweet/1617781985967239170'
		style='position:absolute;top:0;left:0;width:100%;height:100%;'
	></iframe>
</div>
...
<div align='center'>
	<img
		src='https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2Fb48bdfe207bb49ccb9bf0a404dafaad9?width=800'
		alt='a slide with a graph showing a figurative x-axis showing how Qwik enables O(1) apps. Text on the right: "Correlation between functionality and amount of JS is broken".'
	/>
</div>
...
- [QRL](https://qwik.builder.io/docs/advanced/qrl/)
...
<div style='position:relative;padding-bottom:56.25%;height:0;'>
	<iframe
		src='https://qwik-twitter.builder.io/tweet/1625893444374921216'
		style='position:absolute;top:0;left:0;width:100%;height:100%;'
	></iframe>
</div>
