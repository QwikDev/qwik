...
<Image
  src={serviceWorkerVsModulepreloadIllustration}
  alt="Service Worker vs modulepreload illustration"
/>
...
_In the meantime, we'd love your feedback_ — let us know how this update improves your apps on our discord <DiscordLink/>.
