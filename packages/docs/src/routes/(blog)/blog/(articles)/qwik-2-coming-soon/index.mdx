...
export const Counter = component$(() => {
  ...
  return (
    <>
      Count: {count.value}!<button onClick$={() => count.value++}>+1</button>
    </>
  );
});
...
<img
  class="mx-auto"
  src="https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F4b6f0d1119374ce3ab848186972a6f27?width=250"
  alt="mind-blowing meme"
/>
