...
# Qwik v2.0: Faster, More Efficient, and Cleaner HTML
...
>
	 
	<main>  Count: 123!   <button on:click="...">+1</button>  </main>
	 
...
Qwik still needs to have the virtual nodes! So, that information can’t disappear but is now shrunken to just these nine characters: `!{}`.

That is mind-blowing!

![Untitled](https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F4b6f0d1119374ce3ab848186972a6f27?width=250)
