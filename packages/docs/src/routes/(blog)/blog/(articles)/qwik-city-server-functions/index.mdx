...
Today we are thrilled to show what the [Qwik](https://qwik.builder.io/) Core Team has been working on:
...
That's where [Qwik City](https://qwik.builder.io/qwikcity/overview/) enters the scene, a meta framework built on top of the resumability capabilities of Qwik to bring routing and data-fetching patterns. Qwik City is to Qwik, what NextJS is to React, Sveltekit is to Svelte or Solid Start is to Solid.
...
<div align='center'>
	<script
		async
		src='https://qwik-twitter.builder.io/tweet/1598100163528052736'
	></script>
</div>
...
Qwik City goes a long way to execute all relevant loaders as soon as possible and in parallel to keep latency as low as possible, in addition, loaders are connected to the reactivity system of Qwik powered by [signals](https://qwik.builder.io/docs/components/state/#usesignal), so new data will automatically and efficiently update all parts of the app that depend on it.
...
<div align='center'>
	<video
		...
		src='https://cdn.builder.io/o/assets%2FYJIGb4i01jvw0SRdL5Bt%2Fbef031efb09f4b4e9046b9af45e32818%2Fcompressed?apiKey=YJIGb4i01jvw0SRdL5Bt&amp;token=bef031efb09f4b4e9046b9af45e32818&amp;alt=media&amp;optimized=true'
	></video>
</div>
...
[SvelteKit’s ](https://kit.svelte.dev/docs/load)`[load](https://kit.svelte.dev/docs/load)
function` and SolidStart’s `[createResource](https://www.solidjs.com/docs/latest/api#createresource)`
...
export default component$(() => {
	const product = useGetProduct(); // Type of product: {id: string, name: string, description: string}
...
<div align='center'>
	<video
		...
		muted='muted'
		playsinline='playsinline'
		src='https://cdn.builder.io/o/assets%2FYJIGb4i01jvw0SRdL5Bt%2F8db7184f5fac4bbeaff1756fdc440904%2Fcompressed?apiKey=YJIGb4i01jvw0SRdL5Bt&amp;token=8db7184f5fac4bbeaff1756fdc440904&amp;alt=media&amp;optimized=true'
	></video>
</div>
...
You can find the core team in our [discord server](https://qwik.builder.io/chat) or you can tweet out to [QwikDev](https://twitter.com/QwikDev).
