...
<div style="left: 0; width: 100%; height: 0; position: relative; padding-bottom: 56.25%;"><iframe src="https://www.youtube.com/embed/l2mBk9meSvc?rel=0" style="top: 0; left: 0; width: 100%; height: 100%; position: absolute; border: 0;" allowfullscreen="" scrolling="no" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture;"></iframe></div>
...
![Graph showing median origin page weight by framework was over the year. Trend shows JS bundle size growing.](https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F72d1b43302fc4c01bae34c33478eb346?width=705)
...
![Screenshot of "old Reddit" network pane emphasizing transfer weight, resource weight, and load finish time.](https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F6bc3b1ab96984b499d697f629a318562?width=705)

Here is the same for the “new Reddit":

![Screenshot of "new Reddit" network pane emphasizing transfer weight, resource weight, and load finish time.](https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F0d7938d82e754f2690d089a2cbf8141a?width=705)

### Notice the difference?

![A screenshot showing the number differences for transferred JS, JS resources dowloaded, and load finish time between "old" and "new" Reddit.](https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F208e2206946b4b83bb7cf6da49b31246?width=705)
...
![JavaScript bundle size growth over the years.](https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2Fec0bdf9a9d704da684710044b2119e97?width=705)
...
![A graph showing correlation between UX/DX and framework generation over time. When we improve DX we degraded UX.](https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F72ff51d95b434de88b0792eb542052c4?width=705)
...
![An illustration showing how client side rendering and server-side rendering work.](https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2Fa73ececc179c4041839a5b2f5fd58935?width=705)
...
![An image of Russel Crow from the movie Beautiful Minds next to a chalk board looking confused.](https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2Fda36b76063964693b5cadf0d1e39c2a4?width=705)
...
![A slide explaining why hydration is like replaying an app. Rendering runs twice. All logic needs to be dowloaded.](https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2Ffd261206acf2431a8d91cc299365593a?width=705)
...
![A slide explaining resumability. Leverage what already ran on the server. Server serializes app state then it resumes.](https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F0fc18d23965146978693d6f2033d1f77?width=705)
...
![An image showing icons of replayable frameworks next to resumable frameworks.](https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F370aa063cf4d4a95a2f38d689f799bf5?width=705)
...
![A graph and a table showing startup performance on todo application in different frameworks with the Mitosis logo in the bottom left.](https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F3dd274cd6d034d6e8eb4032e4a94d6af?width=705)
...
<div class="css-79elbk"><video controls="" loop="" preload="metadata" class="builder-video css-cz4v3a" muted="muted" playsinline="playsinline"><source type="video/mp4" src="https://cdn.builder.io/o/assets%2FYJIGb4i01jvw0SRdL5Bt%2F7dcdcef346664e4dba0b7b926adf2845%2Fcompressed?apiKey=YJIGb4i01jvw0SRdL5Bt&amp;token=7dcdcef346664e4dba0b7b926adf2845&amp;alt=media&amp;optimized=true"/></video>

**For demo purposes, I’m not going to go into how to start a Qwik project. For more info on getting started with Qwik,** [**check out the Qwik docs**](https://qwik.builder.io/) **or our** [**Stackblitz Qwik Starter**](https://stackblitz.com/)**.**

<div class="builder-block builder-b118c389b0a048c482267f04a862b584 css-9l7gvw" builder-id="builder-b118c389b0a048c482267f04a862b584"><div class="builder-block builder-cf5716e7b63c480a9c216506c23bf8d6 css-xw2ioc" builder-id="builder-cf5716e7b63c480a9c216506c23bf8d6"><img role="presentation" loading="lazy" class="builder-image css-12153wi" src="https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F86cb85533e5d469e8ffeed519e2a794a?width=45" alt="" srcset="https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F86cb85533e5d469e8ffeed519e2a794a?width=100 100w, https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F86cb85533e5d469e8ffeed519e2a794a?width=200 200w, https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F86cb85533e5d469e8ffeed519e2a794a?width=400 400w, https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F86cb85533e5d469e8ffeed519e2a794a?width=800 800w, https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F86cb85533e5d469e8ffeed519e2a794a?width=1200 1200w, https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F86cb85533e5d469e8ffeed519e2a794a?width=1600 1600w, https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F86cb85533e5d469e8ffeed519e2a794a?width=2000 2000w, https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F86cb85533e5d469e8ffeed519e2a794a?width=45 45w"/>
</div>
<div class="builder-block builder-b64f7ebf8eb04aaf8d4d38111f02ce7f css-flfydi" builder-id="builder-b64f7ebf8eb04aaf8d4d38111f02ce7f"><p><strong>Tip: </strong>For the code for this demo, check out the<a href="https://github.com/BuilderIO/qase-for-qwik" rel="noopener noreferrer" target="_blank"> Qase for Qwik GitHub repo</a>.</p></div>
</div>

What we’ve done is create a simple counter component inside a [QwikCity](https://qwik.builder.io/qwikcity/overview/) project, which is the meta-framework for Qwik. Basically, it’s like SvelteKit for Svelte, or [SolidStart](https://start.solidjs.com/getting-started/what-is-solidstart) for Solid. It is generally in charge of routing and the build.

If you're coming from React (or Solid), you can see that a lot of the above looks familiar. As Qwik uses JSX, you should feel right at home. A [signal](https://qwik.builder.io/docs/components/state/#usesignal) is a reactive piece of state, similar to [Solid.js signals](https://www.solidjs.com/tutorial/introduction_signals), which consists of an object with a single property (`signal.value`) that when changed will update any component that uses it. Similarly, `useStore` is almost the same as a signal but accepts an object as a parameter, that then becomes reactive.

The second thing to notice is the `$` sign after `component$` and `onClick$`, which is [a symbol in Qwik.](https://qwik.builder.io/docs/advanced/dollar/) These are hints for the optimizer to break our code into pieces that can later be loaded intelligently. It’s important to note that only serializable data can be used in a lazy-loaded boundary.

<div class="css-79elbk"><video autoplay="autoplay" loop="" preload="metadata" class="builder-video css-cz4v3a" muted="muted" playsinline="playsinline"><source type="video/mp4" src="https://cdn.builder.io/o/assets%2FYJIGb4i01jvw0SRdL5Bt%2F7c770f33ae5e449abfe9053db642bb17%2Fcompressed?apiKey=YJIGb4i01jvw0SRdL5Bt&amp;token=7c770f33ae5e449abfe9053db642bb17&amp;alt=media&amp;optimized=true"/></video><div class="css-13hm15z"></div></div>
...
<div class="css-79elbk"><video autoplay="autoplay" loop="" preload="metadata" class="builder-video css-cz4v3a" muted="muted" playsinline="playsinline"><source type="video/mp4" src="https://cdn.builder.io/o/assets%2FYJIGb4i01jvw0SRdL5Bt%2F346b83d8805049bea52b89f86636c86a%2Fcompressed?apiKey=YJIGb4i01jvw0SRdL5Bt&amp;token=346b83d8805049bea52b89f86636c86a&amp;alt=media&amp;optimized=true"/></video><div class="css-1fj2kn1"></div></div>
...
![A screenshot of devtools network pane showing the downloaded JS core runtime script.](https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F3afeda28406d43a4b836abf83c4382b9?width=705)
...
![A screenshot of devtools network pane showing the downloaded JS onClick script.](https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F5b57e2250dd9453597b9fc04b73b202f?width=705)
...
![a screenshot of devtools HTML pane showing the added HTML attributes Qwik puts in.](https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F201521a817764a4d82efe426a99af80d?width=705)

We can see where the reference to the script is ☝🏽.

And then we can see where more information is stored:

![a screenshot of devtools HTML pane showing the JSON data Qwik puts inside a script tag.](https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F3fdee7eb6f904541b06c2f8c51a77a60?width=705)
...
![A graph showing other tools and Qwik's start up process. The X axis shows time, the Y axis labels other tools and Qwik.](https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F2122a8666d054d6181f855eb046319f0?width=705)
...
<video autoplay="autoplay" loop="" preload="metadata" muted="muted" playsinline="playsinline">
  <source type="video/mp4" src="https://cdn.builder.io/o/assets%2FYJIGb4i01jvw0SRdL5Bt%2Fe8c69a32753a470c986205ddeec55db1%2Fcompressed?apiKey=YJIGb4i01jvw0SRdL5Bt&amp;token=e8c69a32753a470c986205ddeec55db1&amp;alt=media&amp;optimized=true"/>
</video>
...
Most people measure web apps and website performance nowadays with Google Lighthouse, [Page Speed Insights](https://pagespeed.web.dev/) , or the good ol’ [WebPageTest](https://www.webpagetest.org).
...
![An image of the filmstrip output from WebPageTest of Builder.io's Next.js site version next to Qwik site version depicting load time.](https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F72df61989dcd43448b093e77d7eb80d7?width=705)

Right away, the Next.js site starts loading something visual while Qwik showed almost everything after 2.5 seconds.

![An image of the filmstrip output from WebPageTest of Builder.io's Next.js site version load time.](https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F6806377578ba426fa919b469bf4d431f?width=705)
...
![A screenshot of the timings graph from WebPageTest comparing Builder's Next.js site version vs Builder's Qwik site version.](https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2Fe15c79d065364f1e8087c4f10a835b6f?width=705)
...
![A screenshot of Lighthouse score for Builder's Next.js site version version. The performance score is 33.](https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F8a477ecd0b8747cf99c61d5196a4aa61?width=705)
...
![A grpah of metrics from Crux that shows the percentage of good CWV scores. Arrows pointing at Qwik lines and table data. The Y axis is origins having good CWV, the X axis is a timeline from January 2020 to September 2022.](https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F2f7dd984b82b445e9359f9393d16b0f3?width=705)
...
![An image of the Qwik team: Misko Hevery, Manu Almeida, and Adam Bradley with the title "Built by Performance Nerds".](https://cdn.builder.io/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F7a17c9c66a31475cb9fbf422789b0fbe?width=705)
