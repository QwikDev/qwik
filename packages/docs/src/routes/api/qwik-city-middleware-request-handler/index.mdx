...
| Property                                                                 | Modifiers | Type                                                     | Description |
| ------------------------------------------------------------------------ | --------- | -------------------------------------------------------- | ----------- |
| [env](./qwik-city.serverrequestevent.env.md)                             |           | EnvGetter                                                |             |
| [getWritableStream](./qwik-city.serverrequestevent.getwritablestream.md) |           | [ServerResponseHandler](#serverresponsehandler)&lt;T&gt; |             |
| [locale](./qwik-city.serverrequestevent.locale.md)                       |           | string \| undefined                                      |             |
| [mode](#serverrequestevent-mode)                                         |           | [ServerRequestMode](#serverrequestmode)                  |             |
| [platform](./qwik-city.serverrequestevent.platform.md)                   |           | any                                                      |             |
| [request](./qwik-city.serverrequestevent.request.md)                     |           | Request                                                  |             |
| [url](./qwik-city.serverrequestevent.url.md)                             |           | URL                                                      |             |
