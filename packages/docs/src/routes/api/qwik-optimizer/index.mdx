...
```typescript
export declare type EmitMode = "dev" | "prod" | "lib" | "hmr";
```

<h2 id="entrystrategy">EntryStrategy</h2>

```typescript
export declare type EntryStrategy =
  | InlineEntryStrategy
  | HoistEntryStrategy
  | SingleEntryStrategy
  | HookEntryStrategy
...
```typescript
export declare interface HoistEntryStrategy
```
...
```typescript
export declare interface SegmentAnalysis
```
...
```typescript
export declare interface SegmentEntryStrategy
```
...
```typescript
export declare type SystemEnvironment =
  | "node"
  | "deno"
  | "bun"
  | "webworker"
