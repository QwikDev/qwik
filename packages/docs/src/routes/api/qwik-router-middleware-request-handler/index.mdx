...
[originalUrl](./router.requesteventbase.originalurl.md)
...
[rewrite](./router.requesteventcommon.rewrite.md)
...
[(constructor)(pathname)](./router.rewritemessage._constructor_.md)
