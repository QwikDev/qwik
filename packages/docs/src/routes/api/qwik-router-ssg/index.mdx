...
```typescript
export declare function runSsg(opts: SsgOptions): Promise<never>;
```
...
```typescript
export declare function startWorker(opts: SsgOptions): Promise<void>;
```
...
[qwikRouterConfig](./router.staticgenerateoptions.qwikrouterconfig.md)
...
[render](./router.staticgenerateoptions.render.md)
...
[workerFilePath?](./router.staticgenerateoptions.workerfilepath.md)
