---
title: \@qwik.dev/qwik-router/vite/cloudflare-pages API Reference
---

# [API](/api) &rsaquo; @qwik.dev/qwik-router/vite/cloudflare-pages
...
[Edit this section](https://github.com/QwikDev/qwik/tree/main/packages/qwik-router/src/adapters/cloudflare-pages/vite/index.ts)
...
[functionRoutes?](./router.cloudflarepagesadapteroptions.functionroutes.md)
...
[staticPaths?](./router.cloudflarepagesadapteroptions.staticpaths.md)
