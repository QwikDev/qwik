---
title: \@qwik.dev/qwik-router/vite/netlify-edge API Reference
---

# [API](/api) &rsaquo; @qwik.dev/qwik-router/vite/netlify-edge
...
[excludedPath?](./router.netlifyedgeadapteroptions.excludedpath.md)
...
[functionRoutes?](./router.netlifyedgeadapteroptions.functionroutes.md)
...
[staticPaths?](./router.netlifyedgeadapteroptions.staticpaths.md)
