...
\{ (): Editable&lt;[ActionStore](#actionstore)&lt;unknown, unknown&gt;&gt;; \_\_brand: "server_action"; \_\_validators: [DataValidator](#datavalidator)[]; \_\_qrl: QRL&lt;(form: [JSONObject](#jsonobject), event: RequestEventAction) =&gt; unknown&gt;; \_\_id: string; \_\_invalidate: string[] \| undefined; }
