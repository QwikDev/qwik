...
**References:** [DataValidator](#datavalidator), [Loader](#loader)
...
export type GetValidatorInputType<VALIDATOR extends TypedDataValidator> =
  VALIDATOR extends SchemaDataValidator<infer T>
    ? StandardSchemaV1.InferInput<T>
    : never;
```

**References:** [TypedDataValidator](#typeddatavalidator), [SchemaDataValidator](#schemadatavalidator)
...
<h2 id="schemaconstructor">SchemaConstructor</h2>
...
**References:** [SchemaDataValidator](#schemadatavalidator)

[Edit this section](https://github.com/QwikDev/qwik/tree/main/packages/qwik-router/src/runtime/src/types.ts)

<h2 id="schemadatavalidator">SchemaDataValidator</h2>
...
export type SchemaDataValidator<T extends StandardSchemaV1 = StandardSchemaV1> =
  {
    validate(
      ...
      ValidatorReturn<ValidatorErrorType<StandardSchemaV1.InferInput<T>>>
    >;
  };
```

**References:** [ValidatorReturn](#validatorreturn), [ValidatorErrorType](#validatorerrortype)
...
> Warning: This API is now obsolete.
>
> Prefer `schema$`, which accepts any Standard Schema validator.
