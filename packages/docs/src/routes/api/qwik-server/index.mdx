...
```typescript
export declare function getQwikBackpatchExecutorScript(opts?: { debug?: boolean }): string;
```
...
```typescript
export declare function getQwikPrefetchWorkerScript(opts?: { debug?: boolean }): string;
```
