...
```typescript
useOn: (event: CustomEventType | CustomEventType[], eventQrl: QRL<(ev: Event) => void> | undefined) => void
```
...
```typescript
useOnDocument: (event: CustomEventType | CustomEventType[], eventQrl: QRL<(ev: Event) => void> | undefined) => void
```
...
```typescript
useOnWindow: (event: CustomEventType | CustomEventType[], eventQrl: QRL<(ev: Event) => void> | undefined) => void
```
