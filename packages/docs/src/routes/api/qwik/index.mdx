...
```typescript
export declare function setEvent(
  element: Element,
  key: string,
...
(event: Event, element: Element) =&gt; unknown
...
[Edit this section](https://github.com/QwikDev/qwik/tree/main/packages/qwik/src/core/vdomless/dom/event/event.ts)
