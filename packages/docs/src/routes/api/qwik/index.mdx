...
Rendered in place of the subtree when a descendant throws. For screen-reader announcement, render a live region in the fallback (e.g. `<div role="alert">`); the swap itself adds none.
