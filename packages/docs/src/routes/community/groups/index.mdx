...
<div class="card-grid">
  <a class="card card-center" href="https://qwik.dev/chat">
    <p class="icon" align="center">
      <img src="/ecosystem/discord.svg" width={84} height={84} />
    </p>
