...
<div class="card-grid">
  <a class="card card-center" href="https://corrosive.dev/">
    <p class="icon" align="center"><img src="https://github.com/Mahdi-Movahedian-Atar/corrosive-components/blob/master/assets/Corrosive.svg" width="128px"/></p>
    <h3>Corrosive Components - The second and the quickest Qwik component library</h3>
  </a>
</div>
