import { $, useSignal, component$, type QRL, useStylesScoped$ } from '@qwik.dev/core';
...
export default component$(() => {
  ...
  return (
    <>
      ...
      {debouncedValue.value ? debouncedValue.value : <span>Waiting for input to debounce.</span>}
    </>
  );
});
