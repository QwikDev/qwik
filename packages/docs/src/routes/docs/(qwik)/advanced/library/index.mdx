...
<PackageManagerTabs>
  <span q:slot="pnpm">```shell pnpm create qwik library my-library ```</span>
  <span q:slot="npm">```shell npm create qwik library my-library ```</span>
  <span q:slot="yarn">```shell yarn create qwik library my-library ```</span>
  <span q:slot="bun">```shell bun create qwik library my-library ```</span>
</PackageManagerTabs>
