...
Qwik provides various strategies to prefetch modules ahead of time.  Qwik City is able to go even further using [Speculative Module Fetching](../../../(qwikcity)/advanced/speculative-module-fetching/index.mdx). This page describes the **low-level** features of Qwik's prefetching. It is recommended to refer to Qwik City's documentation on [Speculative Module Fetching](../../../(qwikcity)/advanced/speculative-module-fetching/index.mdx) for a more comprehensive understanding.
