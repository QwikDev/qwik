---
title: Synchronous Events with State | Advanced
contributors:
  - mhevery
  - RumNCodeDev
---
...
<Note>If you only need to prevent the default behavior, you can simply use the standard [`preventDefault:{eventName}`](/docs/core/events/#prevent-default) syntax. This is strictly for when you need to chain events together synchronously.</Note>
