...
- As all [`use-`](/docs/(qwik)/components/tasks/index.mdx#use-method-rules) methods it is used at the root of the [`component$()`](/docs/(qwik)/components/overview/index.mdx#component).
