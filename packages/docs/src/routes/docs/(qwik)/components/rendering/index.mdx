...
For more explanation see :
  - `$`, see [The Dollar $ Sign)](../../advanced/dollar/index.mdx).
  - Checkout [Optimizer Rules](../../advanced/optimizer/index.mdx).
  - `q:obj`, see [Serialization](../../concepts/resumable/index.mdx).
  - `on:click`, see [Qwikloader](../../advanced/qwikloader/index.mdx).
