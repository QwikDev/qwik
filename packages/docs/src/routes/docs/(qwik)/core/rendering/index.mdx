...
Wrap that part of the UI in [`<Pending>`](/docs/labs/pending/) when you want a fallback boundary:
...
`<Pending>` does not define the work. It only controls what renders while that part of the UI waits.
