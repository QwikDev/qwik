...
You can easily deploy a Qwik App in any [serverless environment thanks to our adapters](/deployments/index.mdx), we also support a [vanilla-node adaptor](/deployments/node/index.mdx) for Nodejs-based servers, such as Express.
