...
Qwik is designed with React developers in mind, ensuring it's [effortless to learn] (/docs/(qwikcity)/guides/react-cheat-sheet/index.mdx) and promotes rapid productivity. Developing components is pretty much the same as React, and routing is inspired by Nextjs and others.
