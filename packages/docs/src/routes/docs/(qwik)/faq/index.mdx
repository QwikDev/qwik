...
We designed Qwik to be [extremely easy to learn](/docs/(qwik)/cheat/qwik-react/) and become productive in for React developers. Component authoring is pretty much the same as React, and routing is inspired by Nextjs and others.
