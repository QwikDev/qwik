...
## Is Qwik "Alex Russell Approved" framework?

Yes! Alex Russell ([@slightlylate](https://twitter.com/slightlylate)) who is known for his contributions to PWAs, W3C TAG, WC, TC39 & ES6, Chrome Frame, Dojo, and is often very critical of JavaScript frameworks, approves of Qwik.
