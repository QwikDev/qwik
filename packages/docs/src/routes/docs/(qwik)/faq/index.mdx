...
We designed Qwik to be [extremely easy to learn](/docs/(qwikcity)/guides/qwik-react/index.mdx) and become productive in for React developers. Component authoring is pretty much the same as React, and routing is inspired by Nextjs and others.
