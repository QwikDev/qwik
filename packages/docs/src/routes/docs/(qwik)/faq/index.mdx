...
Originally it was called _qoot_, but we thought it would be too hard to search for. One community member, [@PatrickJS](https://x.com/PatrickJS), came up with _Qwik_ and after an internal poll at [builder.io](https://www.builder.io/), we changed it!
