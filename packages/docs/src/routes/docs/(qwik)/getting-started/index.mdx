...
- [ServiceWorker cache](/docs/(qwikrouter)/advanced/speculative-module-fetching/index.mdx#pre-populating-the-cache-with-a-service-worker)import PackageManagerTabs from '~/components/package-manager-tabs/index.tsx';
