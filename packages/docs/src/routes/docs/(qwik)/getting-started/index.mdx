...
<CodeSandbox src="/src/routes/demo/getting-started/01-route/index.tsx">
...
<LongNote title="Route and Component Basics">
...
<CodeSandbox src="/src/routes/demo/getting-started/02-loading-data/index.tsx">
