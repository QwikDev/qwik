...
For more details about how to author components see the [Component API](/docs/components/overview/) section.
...
- `useDadJoke` is a use-hook that returns a [signal](/docs/components/state/#usesignal/) of the server data.
