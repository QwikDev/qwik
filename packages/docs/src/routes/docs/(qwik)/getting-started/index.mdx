...
We will use the external JSON API at https://icanhazdadjoke.com to load random jokes. We will use [route loaders](/docs/route-loader/) to load this data into the server and render it in the component.
