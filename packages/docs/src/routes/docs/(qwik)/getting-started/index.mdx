...
<PackageManagerTabs>
  <span q:slot="pnpm">```shell pnpm create qwik@latest ```</span>
  <span q:slot="npm">```shell npm create qwik@latest ```</span>
  <span q:slot="yarn">```shell yarn create qwik ```</span>
  <span q:slot="bun">```shell bun create qwik@latest ```</span>
</PackageManagerTabs>
...
<PackageManagerTabs>
  <span q:slot="pnpm">```shell pnpm run start ```</span>
  <span q:slot="npm">```shell npm run start ```</span>
  <span q:slot="yarn">```shell yarn run start ```</span>
  <span q:slot="bun">```shell bun run start ```</span>
</PackageManagerTabs>
...
<PackageManagerTabs>
  <span q:slot="pnpm">```shell pnpm run preview ```</span>
  <span q:slot="npm">```shell npm run preview ```</span>
  <span q:slot="yarn">```shell yarn run preview ```</span>
  <span q:slot="bun">```shell bun run preview ```</span>
</PackageManagerTabs>
