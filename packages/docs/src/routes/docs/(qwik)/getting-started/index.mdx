...
import { routeLoader$, Form, routeAction$ } from '@qwikdev/city';
...
3. Import `useStylesScoped$` from `qwik`.
   ```tsx /useStylesScoped$/
   import { component$, useSignal, useStylesScoped$, useTask$ } from "@qwikdev/core";
...
- [ServiceWorker cache](/docs/(qwikcity)/advanced/speculative-module-fetching/index.mdx#pre-populating-the-cache-with-a-service-worker)import PackageManagerTabs from '~/components/package-manager-tabs/index.tsx';
import CodeSandbox from '../../../../components/code-sandbox/index.tsx';
import PackageManagerTabs from '~/components/package-manager-tabs/index.tsx';
import CodeSandbox from '../../../../components/code-sandbox/index.tsx';
