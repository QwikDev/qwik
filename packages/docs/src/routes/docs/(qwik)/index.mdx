...
import ImgQwikRouterAndRouting from '~/media/icons/qwikRouter_and_routing.svg?jsx';
...
<div class="card-grid">
  ...
  <a class="card card-center" href="/docs/qwikrouter/">
    <ImgQwikRouterAndRouting class="intro-icon" />
    <h3>Qwik Router</h3>
  </a>
</div>
...
<div class="card-grid">
  ...
  <div class="card">
    ...
    <p>
      Qwik apps work instantly without any delay because they don't need hydration, regardless of
  ...
  <div class="card">
    <h3>JS Streaming</h3>
    <p>
      Qwik delivers sub-second full page loads, even on mobile, by serving pure HTML and executing
      JavaScript when your users opt-in.
    </p>
  </div>
</div>
