...
<div class="card-grid">
  <Link class="card card-center" href="/docs/getting-started/">
    <p class="icon">🚀</p>
    <h3>Getting Started</h3>
  </Link>
  <Link class="card card-center" href="/docs/think-qwik/">
    <p class="icon">🤔</p>
    <h3>Why Qwik?</h3>
  </Link>
  <Link class="card card-center" href="/docs/components/overview/">
    <p class="icon">📚</p>
    <h3>API</h3>
  </Link>
  <Link class="card card-center" href="https://qwik.builder.io/chat">
    <p class="icon">{getCommunity()}</p>
    <h3>Community</h3>
  </Link>
  <Link class="card card-center" href="/docs/qwikcity/">
    <p class="icon">🌃</p>
...
<div class="card-grid">
  <Link class="card card-center" href="/media/">
    <p class="icon">📺</p>
    <h3>See more presentations, videos, and podcasts</h3>
  </Link>
  <Link class="card card-center" href="/showcase/">
    <p class="icon">🛠️</p>
