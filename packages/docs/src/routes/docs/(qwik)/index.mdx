...
<div class="card-grid">
  <a class="card card-center" href="/docs/getting-started/">
    <img class="icon" src="/icons/getting_started_rocket.svg" width={45} style="margin-bottom:-7px"/>
    <h3>Getting Started</h3>
  </a>
  <a class="card card-center" href="/docs/think-qwik/">
    <img class="icon" src="/icons/why_qwik_logo.svg" width={70}/>
    <h3>Why Qwik?</h3>
  </a>
  <a class="card card-center" href="/api/">
    <img class="icon" src="/icons/api_server.svg" width={70} style="margin-bottom:15px"/>
    <h3>API</h3>
  </a>
  <a class="card card-center" href="/ecosystem/#courses">
    <img class="icon" src="/icons/courses_book.svg" width={95} style="margin-bottom:15px"/>
    <h3>Courses</h3>
  </a>
  <a class="card card-center" href="https://qwik.builder.io/chat">
     <img class="icon" src="/icons/community_chat.svg" width={80}/>
    <h3>Community</h3>
  </a>
  <a class="card card-center" href="/docs/qwikcity/">
    <img class="icon" src="../../../public/icons/qwikCity_and_routing.svg" width={70}/>
...
<div class="card-grid">
  <a class="card card-center" href="/media/">
    <img class="icon" src="../../../public/icons/see_more_media.svg"/>
    <h3>See more presentations, videos, and podcasts</h3>
  </a>
  <a class="card card-center" href="/showcase/">
    <img class="icon" src="../../../public/icons/showcase.svg"/>
