...
<div class="card-grid">
  ...
  <a class="card card-center" href="/ecosystem/#courses">
    <p class="icon">
      <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 48 48" style="display: inline-block">
        <g fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth="4">
          <path d="M8 7h32v24H8z"></path>
          <path strokeLinecap="round" d="M4 7h40M15 41l9-10l9 10M16 13h16m-16 6h12m-12 6h6"></path>
        </g>
      </svg>
    </p>
    <h3>Courses</h3>
  ...
  <a class="card card-center" href="https://qwik.builder.io/community/groups/#-global-communities">
     <p class="icon">🌐</p>
    <h3>Community</h3>
  </a>
