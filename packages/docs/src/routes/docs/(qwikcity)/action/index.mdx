...
description: >-
  Learn about actions in QwikCity, allowing form submissions, and performing
  side effects such as writing to a database or sending an email.
contributors:
  - manucorporat
  - cunzaizhuyi
  - forresst
  ...
  - wtlin1228
  - adamdbradley
updated_at: '2023-10-26T19:00:25Z'
