...
The `action.formData` is specially useful as it allows to keep the form data filled by the user even on a page refresh, ensuring a full SPA experience, even with JS disabled.
