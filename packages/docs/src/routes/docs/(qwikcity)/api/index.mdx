...
<img width="320" alt="placeholder-1" src="/components/image/placeholder-1.png">

#### `background: 'linear-gradient(180deg, rgba(2,0,36,1) 0%, rgba(166,206,247,1) 0%, rgba(37,99,235,1) 83%);';`

<img width="320" alt="placeholder-2" src="/components/image/placeholder-2.png">
...
<img width="320" alt="placeholder-3" src="/components/image/placeholder-3.png">


#### `background: 'url("/public/placeholder.jpg") no-repeat center / cover';`

<img width="320" alt="placeholder-4" src="/components/image/placeholder-4.png">
