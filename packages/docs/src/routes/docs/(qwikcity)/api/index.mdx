...
The `qwikCityPlan.routes` property is used to retrieve the list of the available routes of your application inside middlewares, endpoints or other Qwik APIs.
