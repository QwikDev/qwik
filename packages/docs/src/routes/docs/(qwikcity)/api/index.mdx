...
The `Image` component works like the `<img>` element, but load images at the right size, defined by properties or following responsive breakpoints.

> Notice that there is the possibility to globally define some properties like resolutions or imageTransformer$.
...
<img width="312" alt="Screenshot 2023-03-08 at 13 39 18" src="https://user-images.githubusercontent.com/35845425/223715512-d097de71-09a8-4e55-aa54-f59850e0a3a3.png">
...
<img width="312" alt="Screenshot 2023-03-09 at 09 01 05" src="https://user-images.githubusercontent.com/35845425/223958138-bdb0f110-460b-4fb3-a114-e7b9d63c12b6.png">


#### `background: 'url("/public/placeholder.jpg") no-repeat center / cover';`

<img width="312" alt="Screenshot 2023-03-08 at 13 38 23" src="https://user-images.githubusercontent.com/35845425/223715374-ea5a41fa-a7df-42e1-af1b-2c0322608397.png">
