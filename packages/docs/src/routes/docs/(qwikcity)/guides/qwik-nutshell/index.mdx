...
Qwik executes the same code in the server and in the browser, you can not use `window` or other browser APIs in your code, because they don't exist when the code is executed in the server.
