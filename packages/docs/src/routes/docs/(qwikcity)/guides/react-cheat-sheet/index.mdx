...
<details>
  ...
  <p><a href="https://qwik.builder.io/docs/components/rendering/#bind-attribute">bind attribute</a> It is a convenient API to two-way data bind the value of a `input` to a Signal.</p>
</details>
