---
title: RouteAction$ | QwikRouter
description: Learn about actions in QwikRouter, allowing form submissions, and performing side effects such as writing to a database or sending an email.
contributors:
  - manucorporat
  - cunzaizhuyi
  - forresst
