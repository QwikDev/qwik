...
<Note>During development and in preview mode, the custom 404 pages will not be rendered, but instead the default Qwik Router 404 page will show. However, when building the app for production, the custom 404 page will be statically generated as a static `404.html` file.</Note>
