...
description: Learn how to generate a sitemap for your site in Qwik Router.
contributors:
  - adamdbradley
  - hbendev
  - mrhoodz
...
import { getRoutes, type RequestHandler } from "@qwik.dev/router";
...
This route dynamically creates the sitemap XML based on the routes in your Qwik application.
