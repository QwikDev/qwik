...
Qwik Router comes with server middleware that allows you to centralize and chain logic such as authentication, security, caching, redirects, and logging. Middleware can also be used to define endpoints. Endpoints are useful for returning data such as  RESTful API, or GraphQL API.
...
Qwik Router looks into each file in order and checks to see if it has `onRequest` (or `onGet`, `onPost`, `onPut`, `onPatch`, and `onDelete`) exported functions. If found the function gets added into the middleware execution chain in that order. 
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/component/index.tsx">
```tsx
...
> **Security:** Route and layout middleware protects that route's loaders, actions, endpoints, and
> rendered page. It does not run for [`server$` requests](/docs/server$/#middleware-and-server).
> Authorize each sensitive server function directly or use application-wide `plugin.ts` middleware.
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/next/index.tsx">
```tsx /next()/
import { type RequestHandler } from '@qwik.dev/router';
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/throw/index.tsx">
```tsx /next()/
import { type RequestHandler } from '@qwik.dev/router';
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/sharedMap/index.tsx">
```tsx
import { component$ } from '@qwik.dev/core';
import {
  routeLoader$,
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/headers/index.tsx">
```tsx
import { type RequestHandler } from '@qwik.dev/router';
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/cookie/index.tsx">
```tsx
import { type RequestHandler } from '@qwik.dev/router';
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/method/index.tsx">
```tsx
import { type RequestHandler } from '@qwik.dev/router';
...
Returns `false` for normal page requests. Returns `'loader'` for route loader JSON requests and
`'action'` for fetch-based action submissions.

Check `internalRequest` before applying broad middleware rewrites so Qwik Router's internal JSON
requests keep their routing behavior.
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/url/index.tsx">
```tsx
import { type RequestHandler } from '@qwik.dev/router';
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/basePathname/index.tsx">
```tsx
import { type RequestHandler } from '@qwik.dev/router';
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/params/[myId]/index.tsx" url="/src/routes/demo/qwikrouter/middleware/params/some-id/">
```tsx
import { type RequestHandler } from '@qwik.dev/router';
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/query/index.tsx" url="/src/routes/demo/qwikrouter/middleware/query/?someKey=someValue">
```tsx
import { type RequestHandler } from '@qwik.dev/router';
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/parseBody/index.tsx">
```tsx
import { type RequestHandler } from '@qwik.dev/router';
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/cacheControl/index.tsx">
```tsx
import { type RequestHandler } from '@qwik.dev/router';
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/platform/index.tsx">
```tsx
import { type RequestHandler } from '@qwik.dev/router';
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/locale/index.tsx">
```tsx
import { type RequestHandler } from '@qwik.dev/router';
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/status/index.tsx">
```tsx
import { type RequestHandler } from '@qwik.dev/router';
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/redirect/index.tsx">
```tsx
import { type RequestHandler } from '@qwik.dev/router';
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/error/index.tsx">
```tsx
import { type RequestHandler } from '@qwik.dev/router';
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/text/index.tsx">
```tsx
import { type RequestHandler } from '@qwik.dev/router';
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/html/index.tsx">
```tsx
import { type RequestHandler } from '@qwik.dev/router';
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/json/index.tsx">
```tsx
import { type RequestHandler } from '@qwik.dev/router';
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/send/index.tsx">
```tsx
import type { RequestHandler } from '@qwik.dev/router';
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/exit/index.tsx">
```tsx
import { type RequestHandler } from '@qwik.dev/router';
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/env/index.tsx">
```tsx
import { type RequestHandler } from '@qwik.dev/router';
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/getWritableStream/index.tsx">
```tsx
import type { RequestHandler } from '@qwik.dev/router';
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/headerSent/index.tsx">
```tsx
import { type RequestHandler } from '@qwik.dev/router';
...
<CodeSandbox src="/src/routes/demo/qwikrouter/middleware/request/index.tsx">
```tsx
import { type RequestHandler } from '@qwik.dev/router';
