...
Qwik uses Vite to build the project. The `vite.config.mts` file contains the Vite configuration. It's standard for any Vite project. Please refer to the [Vite documentation](https://vitejs.dev/config/) for more information.
