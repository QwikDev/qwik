...
import { helloWorldLink, buttonClickHandlerLink, declareLocalStateLink, counterExampleLink, clockExampleLink, fetchingRequestLink, contextExampleLink, debouncedInputLink, dynamicBackgroundLink, presidentListLink, PlaygroundLink} from "./playground_urls"
...
<PlaygroundLink link={helloWorldLink} />
...
<PlaygroundLink link={buttonClickHandlerLink} />
...
<PlaygroundLink link={declareLocalStateLink} />
...
<PlaygroundLink link={counterExampleLink} />
...
<PlaygroundLink link={clockExampleLink} />
...
export const Fetch = component$(() => {
  const state = useStore({
    url: 'https://api.github.com/repos/BuilderIO/qwik',
...
<PlaygroundLink link={fetchingRequestLink} />
...
<PlaygroundLink link={contextExampleLink} />
...
<PlaygroundLink link={debouncedInputLink} />
...
<PlaygroundLink link={dynamicBackgroundLink} />
...
<PlaygroundLink link={presidentListLink} />
