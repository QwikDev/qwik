...
- [`createContext(contentName)`](../context/index.mdx)  - creates a context refences
...
- [`useOn()`](../events/index.mdx) styles - appends a listener to the component programatically
- [`useOnWindow()`](../events/index.mdx) - appends a window listener to the component programatically
- [`useOnDocument()`](../events/index.mdx) - appends a document listener to the component programatically

### Lifecycles

- [`useMount$()`](../lifecycle/index.mdx) - defines a callback that will be executed on mount time
- [`useServerMount$()`](../lifecycle/index.mdx) - defines a callback that will be executed on mount time on the server only
- [`useWatch$()`](../lifecycle/index.mdx) - defines a callback that will be called before render and/or a watched store changes
- [`useClientEffect$()`](../lifecycle/index.mdx) - defines a callback that will be called after the render, only in the client (browser)
...
- [`<Slot>`](../projection/index.mdx) - declared a content projection slot
