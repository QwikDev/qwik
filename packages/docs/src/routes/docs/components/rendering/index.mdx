...
- For explanation of `$` see [`$` and optimizer rules](../../advanced/optimizer/index.mdx).
- For explanation of `q:host` see [host element](../../components/anatomy/index.mdx).
- For explanation of `q:obj` see [serialization](../../concepts/resumable/index.mdx).
- For explanation of `on:click` see [qwikloader](../../advanced/qwikloader/index.mdx).
