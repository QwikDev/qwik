...
Vite works nicely with many preprocessors. Just make sure, that you've install the required [plugins](https://vitejs.dev/guide/features.html#css-pre-processors).
