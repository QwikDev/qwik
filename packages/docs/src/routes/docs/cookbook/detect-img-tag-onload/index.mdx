...
This behavior is observed during normal navigation, but not in "private window" sessions or when browser caching is disabled, indicating the cache's impact on the event.<br/>
