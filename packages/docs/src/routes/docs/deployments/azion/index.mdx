...
<Note>Remember to change the `origin` in this file to your domain.</Note>
...
<Note>Once the deployment is triggered, Azion will open the browser and take you to a page on the Azion Console where the deployment logs and process can be monitored. If it doesn't open automatically, just click on the provided link.</Note>
