...
Qwik Router Cloudflare Pages adapter allows you to connect Qwik Router to [Cloudflare Pages](https://pages.cloudflare.com/).
...
<PackageManagerTabs>
  <span q:slot="pnpm">```shell pnpm run qwik add cloudflare-pages ```</span>
  <span q:slot="npm">```shell npm run qwik add cloudflare-pages ```</span>
  <span q:slot="yarn">```shell yarn run qwik add cloudflare-pages ```</span>
  <span q:slot="bun">```shell bun run qwik add cloudflare-pages ```</span>
</PackageManagerTabs>
...
- [Cloudflare Pages Middleware Source](https://github.com/QwikDev/qwik/tree/main/packages/qwik-router/middleware/cloudflare-pages/index.ts)
