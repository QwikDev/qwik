...
<PackageManagerTabs>
  <span q:slot="pnpm">```shell pnpm run qwik add ```</span>
  <span q:slot="npm">```shell npm run qwik add ```</span>
  <span q:slot="yarn">```shell yarn run qwik add ```</span>
  <span q:slot="bun">```shell bun run qwik add ```</span>
</PackageManagerTabs>
...
<PackageManagerTabs>
  <span q:slot="pnpm">```shell pnpm run build ```</span>
  <span q:slot="npm">```shell npm run build ```</span>
  <span q:slot="yarn">```shell yarn run build ```</span>
  <span q:slot="bun">```shell bun run build ```</span>
</PackageManagerTabs>
