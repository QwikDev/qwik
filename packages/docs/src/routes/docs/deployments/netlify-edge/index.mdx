...
Qwik Router Netlify Edge adapter allows you to connect Qwik Router to [Netlify Edge Functions](https://docs.netlify.com/edge-functions/overview/).
...
<PackageManagerTabs>
  <span q:slot="pnpm">```shell pnpm run qwik add netlify-edge ```</span>
  <span q:slot="npm">```shell npm run qwik add netlify-edge ```</span>
  <span q:slot="yarn">```shell yarn run qwik add netlify-edge ```</span>
  <span q:slot="bun">```shell bun run qwik add netlify-edge ```</span>
</PackageManagerTabs>
...
<PackageManagerTabs>
  <span q:slot="pnpm">```shell pnpm run deploy ```</span>
  <span q:slot="npm">```shell npm run deploy ```</span>
  <span q:slot="yarn">```shell yarn run deploy ```</span>
  <span q:slot="bun">```shell bun run deploy ```</span>
</PackageManagerTabs>
...
- [Netlify Edge Middleware Source](https://github.com/QwikDev/qwik/blob/main/packages/qwik-router/src/middleware/netlify-edge/index.ts)
