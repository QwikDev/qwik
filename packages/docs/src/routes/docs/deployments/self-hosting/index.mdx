...
<div class="tabs">
  <div class="tabs-header">
    <button class="tab-button active" data-tab="nginx-node">Nginx (Node.js)</button>
    <button class="tab-button" data-tab="nginx-static">Nginx (Static)</button>
    <button class="tab-button" data-tab="apache">Apache</button>
  </div>
  
  <div class="tab-content active" id="nginx-node">
...
```
  ...
  <div class="tab-content" id="nginx-static">
...
server {
    ...
    # Cache settings for build assets
    location /build/ {
        expires 1y;
        add_header Cache-Control "public, max-age=31536000, immutable";
        access_log off;
...
```
  ...
  <div class="tab-content" id="apache">
...
/* Make code blocks in tabs look good */
.tab-content pre {
  margin: 0;
  border-radius: 4px;
}
