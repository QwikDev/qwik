...
Now, you can generate static site while using `Qwik`'s rich ecosystem, file based routing and many more. However, there are some restrictions

## API to be used with static site adapter
