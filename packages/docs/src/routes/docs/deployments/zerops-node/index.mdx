...
> See example [qwik ssr app](https://github.com/zeropsio/recipe-qwik-nodejs) for a quick start.
...
This creates a project called `recipe-qwik` with a Zerops `Node.js` service called `app`.
