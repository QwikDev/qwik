...
You can easily deploy a Qwik App in any [serverless enviroment thanks to our adaptors](../../integrations/deployments/overview/index.mdx), we also support a [vanilla-node adaptor](../../integrations/deployments/node/index.mdx) for Nodejs-based servers, such as Express.
