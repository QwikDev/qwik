...
Originally it was called Cute, but we thought it would be too hard to search for. One friend of us, [@patrickjs__](https://twitter.com/PatrickJS__) came up with Qwik and after some internal poll at [builder.io](https://www.builder.io/), we changed it!
