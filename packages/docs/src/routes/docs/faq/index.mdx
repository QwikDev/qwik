...
You can deploy easily a Qwik App in any [serverless enviroment thanks to our adaptors](../../qwikcity/middleware/overview/index.mdx), we also support a [vanilla-node adaptor](../../qwikcity/middleware/node/index.mdx) for Nodejs-based servers, such as Express.
