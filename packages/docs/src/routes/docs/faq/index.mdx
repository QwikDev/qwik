...
Nope, in production Qwik uses a lot of information generated during SSR to start [prefetching](../../qwikcity/prefetching/overview/index.mdx) only the bits of interactivity of the current page ASAP, this way when the user clicks or interacts, the JS is already downloaded.
