...
Qwik is a new kind of framework that is [resumable](../concepts/resumable/index.mdx) (No JS and no hydration), built for the edge and familiar for React developers.
