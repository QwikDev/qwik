...
Qwik is designed to be integrated with other tools. Such as `vitest`, `tailwinds`, `partytown`... run the following command to see the list of available integrations:
