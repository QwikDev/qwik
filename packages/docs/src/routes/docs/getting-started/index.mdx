...
- They are [resumable](../concepts/resumable/index.mdx) (a component can get created on a server and continue its execution on the client.) See [resumability](../concepts/resumable/index.mdx).
...
Learn about the key concepts of writing [Qwik Components](../components/overview/index.mdx).