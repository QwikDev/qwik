...
<PackageManagerTabs>
  <span q:slot="pnpm">```shell pnpm create @qwik.dev/astro ```</span>
  <span q:slot="npm">```shell npm create @qwik.dev/astro ```</span>
  <span q:slot="yarn">```shell yarn create @qwik.dev/astro ```</span>
  <span q:slot="bun">```shell bun create @qwik.dev/astro ```</span>
</PackageManagerTabs>
...
<PackageManagerTabs>
  <span q:slot="pnpm">```shell pnpm dlx astro add @qwik.dev/astro ```</span>
  <span q:slot="npm">```shell npx astro add @qwik.dev/astro ```</span>
  <span q:slot="yarn">```shell yarn dlx astro add @qwik.dev/astro ```</span>
  <span q:slot="bun">```shell bunx astro add @qwik.dev/astro ```</span>
</PackageManagerTabs>
...
<PackageManagerTabs>
  <span q:slot="pnpm">```shell pnpm install @qwik.dev/astro ```</span>
  <span q:slot="npm">```shell npm install @qwik.dev/astro ```</span>
  <span q:slot="yarn">```shell yarn add @qwik.dev/astro ```</span>
  <span q:slot="bun">```shell bun install @qwik.dev/astro ```</span>
</PackageManagerTabs>
...
<PackageManagerTabs>
  <span q:slot="pnpm">```shell pnpm install @qwik.dev/core ```</span>
  <span q:slot="npm">```shell npm install @qwik.dev/core ```</span>
  <span q:slot="yarn">```shell yarn add @qwik.dev/core ```</span>
  <span q:slot="bun">```shell bun install @qwik.dev/core ```</span>
</PackageManagerTabs>
