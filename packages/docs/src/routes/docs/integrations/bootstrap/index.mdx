...
<PackageManagerTabs>
  <span q:slot="pnpm">```shell pnpm run qwik add bootstrap ```</span>
  <span q:slot="npm">```shell npm run qwik add bootstrap ```</span>
  <span q:slot="yarn">```shell yarn run qwik add bootstrap ```</span>
  <span q:slot="bun">```shell bun run qwik add bootstrap ```</span>
</PackageManagerTabs>
