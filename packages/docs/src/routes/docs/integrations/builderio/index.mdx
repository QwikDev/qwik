...
<PackageManagerTabs>
  <span q:slot="pnpm">```shell pnpm run qwik add builder.io ```</span>
  <span q:slot="npm">```shell npm run qwik add builder.io ```</span>
  <span q:slot="yarn">```shell yarn run qwik add builder.io ```</span>
  <span q:slot="bun">```shell bun run qwik add builder.io ```</span>
</PackageManagerTabs>
...
<PackageManagerTabs>
  <span q:slot="pnpm">```shell pnpm run dev ```</span>
  <span q:slot="npm">```shell npm run dev ```</span>
  <span q:slot="yarn">```shell yarn run dev ```</span>
  <span q:slot="bun">```shell bun run dev ```</span>
</PackageManagerTabs>
