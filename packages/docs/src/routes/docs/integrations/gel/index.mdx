...
contributors:
  - nabrams
updated_at: '2024-08-01T18:53:23Z'
...
The easiest way to add Gel to Qwik is using the Qwik CLI command. This will install the required dependencies and create a `db` folder with the drizzle schema.
