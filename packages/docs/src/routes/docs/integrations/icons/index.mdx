...
<PackageManagerTabs>
  <span q:slot="pnpm">```shell pnpm install @qwikest/icons ```</span>
  <span q:slot="npm">```shell npm install @qwikest/icons ```</span>
  <span q:slot="yarn">```shell yarn add @qwikest/icons ```</span>
  <span q:slot="bun">```shell bun install @qwikest/icons ```</span>
</PackageManagerTabs>
