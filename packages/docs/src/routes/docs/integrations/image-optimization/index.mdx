...
### The goal is a component to support performant images on the web and automatic image optimization.<br><br>

> This is a pluggable component so devs could connect different image loaders to it (like builder.io or other CDNs)

<br>

### Here is the Github repository with detailed instructions on usage and customizations:<br> [qwikifiers/qwik-image](https://github.com/qwikifiers/qwik-image)
