...
<PackageManagerTabs>
  <span q:slot="pnpm">
    ```shell pnpm dlx create-nx-workspace@latest org-workspace --preset=qwik-nx ```
  </span>
  <span q:slot="npm">
    ```shell npx create-nx-workspace@latest org-workspace --preset=qwik-nx ```
  </span>
  <span q:slot="yarn">
    ```shell yarn dlx create-nx-workspace@latest org-workspace --preset=qwik-nx ```
  </span>
  <span q:slot="bun">
    ```shell bunx create-nx-workspace@latest org-workspace --preset=qwik-nx ```
  </span>
</PackageManagerTabs>
...
<PackageManagerTabs>
  <span q:slot="pnpm">```shell pnpm install qwik-nx ```</span>
  <span q:slot="npm">```shell npm install qwik-nx ```</span>
  <span q:slot="yarn">```shell yarn add qwik-nx ```</span>
  <span q:slot="bun">```shell bun install qwik-nx ```</span>
</PackageManagerTabs>
