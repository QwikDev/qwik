...
```
  ...
  <span q:slot="yarn">
```shell
yarn create nx-workspace@latest org-workspace --preset=qwik-nx
```
  </span>
  <span q:slot="pnpm">
```shell
...
```
  ...
  <span q:slot="bun">
```shell
bun add create-nx-workspace
bun run create-nx-workspace@latest org-workspace --preset=qwik-nx
