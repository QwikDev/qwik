...
<PackageManagerTabs>
  <span q:slot="pnpm">```shell pnpm install cssnano ```</span>
  <span q:slot="npm">```shell npm install cssnano ```</span>
  <span q:slot="yarn">```shell yarn add cssnano ```</span>
  <span q:slot="bun">```shell bun install cssnano ```</span>
</PackageManagerTabs>
