...
> **Note:** You CAN NOT use React components in Qwik without converting them first, using `qwikify$()`. Even though [React and Qwik components look similar](/docs/(qwikrouter)/guides/react-cheat-sheet/index.mdx), they are fundamentally very different.
