...
<span q:slot="pnpm">
```shell
pnpm install @supabase/supabase-js @supabase/supabase-auth-helpers-qwik
```
</span>
<span q:slot="npm">
```shell
npm install @supabase/supabase-js @supabase/supabase-auth-helpers-qwik
```
</span>
<span q:slot="yarn">
```shell
yarn add @supabase/supabase-js @supabase/supabase-auth-helpers-qwik
```
</span>
<span q:slot="bun">
```shell
bun install @supabase/supabase-js @supabase/supabase-auth-helpers-qwik
```
</span>
</PackageManagerTabs>
