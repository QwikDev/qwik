...
<PackageManagerTabs>
  <span q:slot="pnpm">```shell pnpm install @tauri-apps/cli ```</span>
  <span q:slot="npm">```shell npm install @tauri-apps/cli ```</span>
  <span q:slot="yarn">```shell yarn add @tauri-apps/cli ```</span>
  <span q:slot="bun">```shell bun install @tauri-apps/cli ```</span>
</PackageManagerTabs>
...
<PackageManagerTabs>
  <span q:slot="pnpm">```shell pnpm run tauri init ```</span>
  <span q:slot="npm">```shell npm run tauri init ```</span>
  <span q:slot="yarn">```shell yarn run tauri init ```</span>
  <span q:slot="bun">```shell bun run tauri init ```</span>
</PackageManagerTabs>
...
1. _What is your frontend build command?_
...
<PackageManagerTabs>
  <span q:slot="pnpm">```shell pnpm run tauri dev ```</span>
  <span q:slot="npm">```shell npm run tauri dev ```</span>
  <span q:slot="yarn">```shell yarn run tauri dev ```</span>
  <span q:slot="bun">```shell bun run tauri dev ```</span>
</PackageManagerTabs>
