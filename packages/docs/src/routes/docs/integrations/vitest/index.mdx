...
If you are looking for an example for a Component with QwikRouter checkout [QwikRouterMockProvider](/docs/(qwikrouter)/api/index.mdx#qwikroutermockprovider).
