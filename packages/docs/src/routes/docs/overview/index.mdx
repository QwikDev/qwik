...
- **Resumable**: Qwik is [resumable](../concepts/resumable/index.mdx) which means Qwik applications require **no hydration**. This allows Qwik apps to have instant-on interactivity.
...
- **Reactive**: Qwik semantics allow for [fully reactive and efficient rendering](../concepts/reactivity/index.mdx).
