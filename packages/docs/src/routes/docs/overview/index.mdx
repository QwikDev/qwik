...
- **Resumable**: Qwik is [resumable](concepts/resumable) which means Qwik applications require **no hydration**. This allows Qwik apps to have instant-on interactivity.
