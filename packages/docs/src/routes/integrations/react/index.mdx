...
> **Note:** You CAN NOT use React components in Qwik without converting them first, using `qwikify$()`. Even though [React and Qwik component look similar](/docs/(qwik)/cheat/qwik-react/), they are fundamentally very different.
