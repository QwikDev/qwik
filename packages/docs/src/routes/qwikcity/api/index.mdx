...
This component is usually located as a children of `<body>`, in most of the starters you will find it in the `src/root.tsx` file:
...
export default component$(() => {
  return (
    <div>
      <a href="/docs" class="my-link">full-page reload</a>
      <Link href="/docs" class="my-link">spa navigation</Link>
    </div>
  )
});
```
