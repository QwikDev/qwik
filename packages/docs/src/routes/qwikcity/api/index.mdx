...
The `action$()` function is used to declare a new Server Action in the given page/endpoint or layout. QwikCity will execute only the invokated action after some user interaction (such as a button click or a form submit).
