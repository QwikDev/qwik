...
`$` marks a closure as lazy-loadable. For example [`component$()`](/docs/components/overview/index.mdx#component) method makes the component lazy-loadable. When you see a `$` in Qwik code, you're crossing a lazy-loading boundary and have to be aware of special rules:
