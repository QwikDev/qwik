...
describe('executeLoader', () => {
  ...
  describe('when validation succeeds', () => {
    ...
    it('should execute loader and store result', async () => {
      ...
      await executeLoader(mockLoader, mockLoaders, mockRequestEvent, true, mockQwikSerializer);
    ...
    it('should not measure in production mode', async () => {
      ...
      await executeLoader(mockLoader, mockLoaders, mockRequestEvent, false, mockQwikSerializer);
  ...
  describe('when validation fails', () => {
    ...
    it('should call fail method', async () => {
      ...
      await executeLoader(mockLoader, mockLoaders, mockEvent, true, mockQwikSerializer);
  ...
  describe('when loader execution throws an error', () => {
    ...
    it('should propagate the error', async () => {
      await expect(
        executeLoader(mockLoader, mockLoaders, mockRequestEvent, true, mockQwikSerializer)
      ).rejects.toThrow('Loader execution failed');
    });
  });
});
