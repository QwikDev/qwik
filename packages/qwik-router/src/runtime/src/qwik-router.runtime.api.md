...
> {
  ...
  onSubmitCompleted$?:
    | QRLEventHandlerMulti<CustomEvent<FormSubmitSuccessDetail<O>>, HTMLFormElement>
    | undefined;
...
export type ZodConstructor = {
  ...
  <T extends z_2.ZodRawShape>(
    schema: (zod: typeof z_2.z, ev: RequestEvent) => T
  ): ZodDataValidator<z_2.ZodObject<T>>;
