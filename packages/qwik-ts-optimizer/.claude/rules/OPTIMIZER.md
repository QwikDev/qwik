...
Two functions, both in `src/optimizer/analysis/capture-analysis.ts`:
...
| Capture analysis | `src/optimizer/analysis/capture-analysis.ts` |
...
- `src/optimizer/analysis/capture-analysis.ts`
