...
| Full suite passing (baseline) | **1153** |
| Last verified | 2026-07-10 on `main` (post PR #342 `17d0962`; OSS-528 destructure-default fix, +1 test) |
