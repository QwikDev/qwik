...
Last updated: 2026-07-08 (PRs #316–#319 — [OSS-509](https://linear.app/kunai/issue/OSS-509) / [OSS-510](https://linear.app/kunai/issue/OSS-510) / [OSS-511](https://linear.app/kunai/issue/OSS-511) all **Done**, + comment-rule hardening). Active workstream [OSS-499](https://linear.app/kunai/issue/OSS-499): validate **qwik-design-system** under qwik-bundler + the TS optimizer. **qds docs build GREEN**; dev-SSR **onion-peel advancing** — carousel `.script.ts` empty-module ([OSS-509](https://linear.app/kunai/issue/OSS-509), PR #316), loop-body computed-key + block/loop-scope capture ([OSS-510](https://linear.app/kunai/issue/OSS-510), PR #317), and `sync$`-in-event-array ([OSS-511](https://linear.app/kunai/issue/OSS-511), PR #318) all FIXED. **Next qds bug: Bug L `_wrapProp(...).map is not a function`** (`docs/src/widgets/search/search.tsx` `Search_component` — not filed). Convergence 203/9; full 1111 → 1125 (+14). **Comment conventions hardened** (PR #319) → **[OSS-512](https://linear.app/kunai/issue/OSS-512)** filed for the codebase-wide comment cleanup (Backlog). OSS-456 parity + OSS-450 integration open in parallel.
...
| Full suite passing (baseline) | **1125** |
| Last verified | 2026-07-08 on `main` (post PR #318; OSS-509 empty-module +4, OSS-510 computed-key/block-scope capture +8, OSS-511 sync$-in-array +2) |
...
|---|---|---|---|---|
| `main` | `770e0bf` (post PR #318) | ✅ | baseline | Active workstream: [OSS-499](https://linear.app/kunai/issue/OSS-499) — qwik-design-system validation under qwik-bundler + tsOptimizer. SWC baseline green; **bug classes A–F fixed**; **Bug G serverQrl SSR crash FIXED** ([OSS-506](https://linear.app/kunai/issue/OSS-506)/[OSS-507](https://linear.app/kunai/issue/OSS-507), PR #313) and **[OSS-508](https://linear.app/kunai/issue/OSS-508)** `_jsxDEV` shorthand (PR #314). **qds docs build GREEN**; dev-SSR onion-peel continuing — carousel `.script.ts` empty-module ([OSS-509](https://linear.app/kunai/issue/OSS-509), PR #316), loop-body computed-key capture ([OSS-510](https://linear.app/kunai/issue/OSS-510), PR #317), and `sync$`-in-event-array ([OSS-511](https://linear.app/kunai/issue/OSS-511), PR #318) all FIXED. **Next qds bug: Bug L `_wrapProp(...).map is not a function`** (`docs/src/widgets/search/search.tsx` `Search_component` — not filed). **+** OSS-456 vite-qwik-router interactive e2e in dev at parity. OSS-498 rename → `qwik-ts-optimizer` In Progress until `npm publish`. Backlog: [OSS-512](https://linear.app/kunai/issue/OSS-512) (codebase-wide comment cleanup — comment rules hardened in PR #319), OSS-448 (scope-aware import DCE), OSS-471, OSS-473, OSS-465 RCA follow-ups, OSS-439 (F3), OSS-450 Sub-D. Code-hygiene track D paused (OSS-489 stage-2). |
