...
Last updated: 2026-06-10 ([OSS-481](https://linear.app/kunai/issue/OSS-481) true NAPI parity for `createOptimizer` — raw-string boundary, branded internally — **merged, PR #244**; qwik-bundler’s `tsOptimizer` adapter reduced to a dynamic import; +2 tests, OPTIMIZER.md audit: non-trigger-touching). Code-hygiene track: OSS-474/476/477/478/479/480 (PRs #232/#234/#236/#238/#240/#242) **Done** — Track C closed; [OSS-475](https://linear.app/kunai/issue/OSS-475) filed (Backlog); tracks B4/D/E open — roadmap in project memory. **Milestone still standing: `vite-qwik-router` is interactive end-to-end in dev under the TS optimizer** (counter + `server$` RPC at parity with SWC; OSS-470 PR #228 + OSS-472 PR #230). Convergence **203/9** unchanged; full suite **1004**. Active workstream [OSS-456](https://linear.app/kunai/issue/OSS-456); parity backlog + RCA follow-ups (OSS-465) and the prod-preview `_run` Q14 (at parity with SWC, bundler/runtime) per the Branches/What-next sections below.
...
| Full suite passing (baseline) | **1004** |
| Last verified | 2026-06-10 on `main` (post PR #244) |
...
|---|---|---|---|---|
| `main` | `29c65ee` (PR #244) | ✅ | baseline | Active workstream: OSS-456 — vite-qwik-router **interactive e2e in dev** (counter + `server$` RPC) under `tsOptimizer`, at parity with SWC; OSS-470 + OSS-472 merged. Backlog: OSS-471 (app migration MOVE — parity, not Q14), OSS-473 (spa_init dev-path), OSS-465 RCA follow-ups; OSS-447 + OSS-448 (block `example_qwik_router_client` flip); OSS-439 (F3); OSS-450 Sub-D. Prod-preview `_run` Q14 at parity with SWC (bundler/runtime). Code-hygiene track: OSS-474/476/477/478/479/480 (PRs #232/#234/#236/#238/#240/#242) merged, OSS-475 filed; Track C closed — tracks B4/D/E open. |
