...
| Last verified | 2026-06-09 on `main` (post PR #234) |
...
|---|---|---|---|---|
| `main` | `1fa42db` (PR #234) | ✅ | baseline | Active workstream: OSS-456 — vite-qwik-router **interactive e2e in dev** (counter + `server$` RPC) under `tsOptimizer`, at parity with SWC; OSS-470 + OSS-472 merged. Backlog: OSS-471 (app migration MOVE — parity, not Q14), OSS-473 (spa_init dev-path), OSS-465 RCA follow-ups; OSS-447 + OSS-448 (block `example_qwik_router_client` flip); OSS-439 (F3); OSS-450 Sub-D. Prod-preview `_run` Q14 at parity with SWC (bundler/runtime). Code-hygiene track: OSS-474 (PR #232) + OSS-476 JSX attr-name helper (PR #234) merged, OSS-475 filed; tracks A/B4/C/D/E open. |
