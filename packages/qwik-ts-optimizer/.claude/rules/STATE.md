...
| Full suite passing (baseline) | **1150** |
| Last verified | 2026-07-09 on `main` (post PR #338 `51d7f51`; OSS-517 const-inline member-mutation fix, +3 unit tests) |
