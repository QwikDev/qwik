...
| Full suite passing (baseline) | **1192** on `main` (post PR #355 — +5 OSS-536 regression tests absorbed) |
| Last verified | 2026-07-15 — post PR #355 merge, `main` baseline auto-updated (`ec4dc0d`): 203/212 convergence + 1192/1217 full passing |
...
**OSS-536 is DONE and merged** (PR #355 on `main` @ `ec4dc0d`); post-merge wrap-up complete (branch deleted, qds dist rebuilt + re-synced, ticket Done). **OSS-531 + OSS-535 also Done + merged** (PRs #351/#352). **OSS-532 is re-diagnosed + parked** — its `readOnly` symptom is a qds-side Qwik-resumption bug, not an optimizer divergence (see header + branches table).
