...
Last updated: 2026-05-09 (post OSS-352 merged + refactor track v2 fully closed; OSS-347 follow-up backlogs and parity work remain)
...
| Full suite failing | 56 / 698 |
| Full suite passing | 642 / 698 |
| Last verified | 2026-05-09 on `main` (post PR #40 merge, head `e7efa3e`) |
...
- ~~**OSS-352 backlog**~~ — closed via PR #40 on 2026-05-09; the `activeSegmentBodies` mechanism now applies uniformly across marker calls, JSX attributes, and the inlinedQrl path.
