 ...
 */
export declare function resolveEntryField(strategyType: EntryStrategyType, symbolName: string, ctxName: string, parentComponentSymbol: string | null, manual: Record<string, string> | undefined): string | null;
export {};
//# sourceMappingURL=entry-strategy.d.ts.map