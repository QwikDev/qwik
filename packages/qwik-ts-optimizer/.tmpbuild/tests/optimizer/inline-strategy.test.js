...
import { buildNoopQrlDeclaration, buildNoopQrlDevDeclaration, buildStrippedNoopQrl, buildStrippedNoopQrlDev, buildSCall, getSentinelCounter, } from '../../src/optimizer/inline-strategy.js';
describe('inline-strategy', () => {
    ...
    describe('buildNoopQrlDeclaration', () => {
        it('produces _noopQrl const declaration', () => {
            ...
            expect(result).toBe('const q_Child_component_9GyF01GDKqw = /*#__PURE__*/ _noopQrl("Child_component_9GyF01GDKqw");');
        });
        it('works with different symbol names', () => {
            const result = buildNoopQrlDeclaration('App_component_ckEPmXZlub0');
            expect(result).toBe('const q_App_component_ckEPmXZlub0 = /*#__PURE__*/ _noopQrl("App_component_ckEPmXZlub0");');
        });
    });
    // -------------------------------------------------------------------------
    ...
    describe('buildNoopQrlDevDeclaration', () => {
        it('produces _noopQrlDEV const declaration with dev metadata', () => {
            ...
            expect(result).toBe('const q_App_component_Cmp_p_q_e_click_Yl4ybrJWrt4 = /*#__PURE__*/ _noopQrlDEV("App_component_Cmp_p_q_e_click_Yl4ybrJWrt4", {\n' +
                '    file: "/user/qwik/src/test.tsx",\n' +
                '    lo: 144,\n' +
                '    hi: 169,\n' +
                '    displayName: "test.tsx_App_component_Cmp_p_q_e_click"\n' +
    ...
    describe('buildStrippedNoopQrlDev', () => {
        it('produces sentinel-named _noopQrlDEV with dev metadata', () => {
            ...
            expect(result).toBe('const q_qrl_4294901760 = /*#__PURE__*/ _noopQrlDEV("App_component_serverStuff_ebyHaP15ytQ", {\n' +
                '    file: "/hello/from/dev/test.tsx",\n' +
                '    lo: 0,\n' +
                '    hi: 0,\n' +
                '    displayName: "test.tsx_App_component_serverStuff"\n' +
...
//# sourceMappingURL=inline-strategy.test.js.map