...
import { getQrlCalleeName, buildQrlDeclaration, buildSyncTransform, needsPureAnnotation, getQrlImportSource, } from '../../src/optimizer/rewrite-calls.js';
...
describe('buildQrlDeclaration', () => {
    it('produces correct format with PURE annotation', () => {
        ...
        expect(result).toBe('const q_App_component_abc12345678 = /*#__PURE__*/ qrl(()=>import("./App_component_abc12345678"), "App_component_abc12345678");');
    });
});
...
//# sourceMappingURL=rewrite-calls.test.js.map