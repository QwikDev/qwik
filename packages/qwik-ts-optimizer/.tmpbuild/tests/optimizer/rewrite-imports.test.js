...
describe('rewriteImportSource', () => {
    ...
    it('@builder.io/qwik-city/more/here -> @qwik.dev/router/more/here', () => {
        expect(rewriteImportSource('@builder.io/qwik-city/more/here')).toBe('@qwik.dev/router/more/here');
    });
    ...
    it('@builder.io/qwik/jsx-dev-runtime -> @qwik.dev/core/jsx-dev-runtime', () => {
        expect(rewriteImportSource('@builder.io/qwik/jsx-dev-runtime')).toBe('@qwik.dev/core/jsx-dev-runtime');
    });
...
//# sourceMappingURL=rewrite-imports.test.js.map