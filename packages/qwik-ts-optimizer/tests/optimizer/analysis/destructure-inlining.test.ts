/**
 * Regression tests for destructure-inlining JSX tag-name rewriting
 * (part of the `example_immutable_analysis` parity work).
 *
...
`);
      ...
      // important invariant here is that the rewrite happened at
