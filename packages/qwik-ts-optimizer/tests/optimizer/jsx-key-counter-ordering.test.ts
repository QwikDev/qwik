/**
 * Tests for OSS-432 Bug C — JSX key counter assignment order.
 *
 ...
 * JSX keys consumed before their parent). The pre-OSS-432 TS pipeline
...
describe('OSS-432 — JSX key counter ordering', () => {
