/**
 * Regression tests for bare-expression `_fnSignal` hoisting
 ...
 * blocking the flip — sibling of the bag-split + paren-norm fixes).
 */
...
`;
    ...
    // _str preserves source `1+2` (folding only applied to the lambda body).
