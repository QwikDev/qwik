/**
 * Regression tests for OSS-406 — propagate `_rawProps` consolidation to
...
describe('OSS-406: Inline strategy keeps captureNames intact for non-loop nested handlers', () => {
...
`;
  ...
  it('default (smart) strategy keeps captureNames empty after promotion (segment-file path)', () => {
    ...
    // behavior pre-OSS-406 — because the segment file's runtime contract
