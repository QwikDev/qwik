...
// OSS-410: JSX dev-info `lineNumber:` / `columnNumber:` must be computed
...
describe('OSS-410 — JSX dev-info source-relative positions', () => {
...
// step — out of scope for OSS-410; the simple body case (no captures)
