/**
 * Regression tests for OSS-431 — foreign `@jsxImportSource` pragma support
 * (Sub-B of the OSS-429 F6 umbrella).
 *
 * Pre-OSS-431: when source carried `/* @jsxImportSource react *‌/`, the
...
import { detectForeignJsxRuntime } from '../../src/optimizer/utils/jsx-import-source.js';
...
describe('OSS-431: foreign @jsxImportSource pragma support', () => {
