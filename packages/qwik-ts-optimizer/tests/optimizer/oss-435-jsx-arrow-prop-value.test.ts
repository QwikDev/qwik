/**
 * Regression tests for OSS-435 — JSX inside arrow-function bodies that
 ...
 * Two coupled fixes:
 *
 *  1. **JSX-in-arrow-prop-value visitation** (documented OSS-435 scope).
 ...
 *     does NOT advance. `countJsxKeyConsumption` (OSS-432 Bug C
...
describe('OSS-435 — JSX inside arrow-function bodies on JSX prop values', () => {
