/**
 * Regression tests for OSS-443 — Sub-C of OSS-440 umbrella
 ...
 *
 * Doesn't flip `example_immutable_analysis` on its own — Sub-D
 * (`.w([captures])` on Component-prop QRLs) is still open under the
 * umbrella.
 */
...
describe('OSS-443 — TS type annotations stripped from non-JSX segment bodies', () => {
