/**
 * Tests for OSS-446 Bug 1 — peer-tool `jsx('tag', { onProp$: $() })` calls
...
describe('OSS-446 Bug 1 — peer-tool jsx() naming context', () => {
...
`;
  ...
  it('negative scope: jsx() from a non-Qwik source is NOT treated as JSX runtime', () => {
    // OSS-431 territory — if the file uses a foreign JSX runtime via
