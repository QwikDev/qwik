import type { Plugin as VitePlugin, Rolldown, UserConfig } from 'vite';
...
export { _deserialize, _getSingleton } from '@qwik.dev/core/internal';
`;
...
export const emitQwikWorkerCoreChunk = (ctx: Rolldown.PluginContext) => {
  return ctx.emitFile({
