...
// @alpha
export const useOn: (event: string, eventQrl: QRL<(event: Event) => void>) => void;

// @alpha
export const useOnDocument: (event: string, eventQrl: QRL<(event: Event) => void>) => void;

// @alpha
export const useOnWindow: (event: string, eventQrl: QRL<(event: Event) => void>) => void;
