...
export type _AllowPlainQrl<Q> =
  QRLEventHandlerMulti<any, any> extends Q
    ? Q extends QRLEventHandlerMulti<infer EV, infer EL>
      ? Q | (EL extends Element ? EventHandler<EV, EL> : never)
      : Q
...
export interface CSSProperties
  extends CSS_2.Properties<string | number>,
    CSS_2.PropertiesHyphen<string | number> {
...
export const _fnSignal: <T extends (...args: any) => any>(
  ...
  args: Parameters<T>,
  fnStr?: string
) => SignalDerived<ReturnType<T>, Parameters<T>>;
...
// @public
const jsx: <T extends string | FunctionComponent<any>>(
  type: T,
...
//
// @internal
export const _pauseFromContexts: (
