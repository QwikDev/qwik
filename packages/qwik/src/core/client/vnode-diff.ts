        ...
        if (shouldRender) {
          if (propsAreDifferent) {
            if (vNodeProps) {
              ...
              if (vNodeProps[_CONST_PROPS]) {
                Object.assign(vNodeProps[_CONST_PROPS], (jsxProps as PropsProxy)[_CONST_PROPS]);
              } else {
                vNodeProps[_CONST_PROPS] = (jsxProps as PropsProxy)[_CONST_PROPS];
              }
              Object.assign(vNodeProps[_VAR_PROPS], (jsxProps as PropsProxy)[_VAR_PROPS]);
            } else if (jsxProps) {
