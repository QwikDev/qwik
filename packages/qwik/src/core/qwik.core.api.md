...
//
// @internal (undocumented)
export const createAsyncComputedQrl: <T>(
...
//
// @internal (undocumented)
export const createSerializerQrl: <T, S>(
  arg: QRL<{
...
export interface CSSProperties
  extends CSS_2.Properties<string | number>, CSS_2.PropertiesHyphen<string | number> {
...
// @public
function h<TYPE extends string | FunctionComponent<PROPS>, PROPS extends {} = {}>(
  type: TYPE,
  props?: PROPS | null,
  ...children: any[]
): JSXNode<TYPE>;
...
// @public
export const jsxs: <T extends string | FunctionComponent<any>>(
  type: T,
  props: T extends FunctionComponent<infer PROPS> ? PROPS : Props,
  key?: string | number | null,
  _isStatic?: boolean,
...
// @internal (undocumented)
export const _resolveContextWithoutSequentialScope: <STATE>(
...
// @internal (undocumented)
export function _vnode_toString(
  this: _VNode | null,
  depth?: number,
  offset?: string,
  materialize?: boolean,
...
// @internal @deprecated (undocumented)
export const _wrapSignal: <T extends object, P extends keyof T>(
  obj: T,
  prop: P
) => T[P] | WrappedProp<T, P>;
