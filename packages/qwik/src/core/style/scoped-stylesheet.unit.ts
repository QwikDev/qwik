...
scopedStyles('selectors', () => {
  ...
  equal(scopeStylesheet('.red * { color: red; }', 'ABC'), '.red.⭐️ABC *.⭐️ABC { color: red; }');
...
scopedStyles('attribute selectors', () => {
  equal(scopeStylesheet('*[target] { color: red; }', 'ABC'), '*[target].⭐️ABC { color: red; }');
  equal(scopeStylesheet('*[target] span { color: red; }', 'ABC'), 'a[target].⭐️ABC span.⭐️ABC { color: red; }');
...
scopedStyles('global function', () => {
  ...
  equal(scopeStylesheet('*[target] :global(span) { color: red; }', 'ABC'), '*[target].⭐️ABC span { color: red; }');
