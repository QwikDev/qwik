 ...
 *   copies of the code. Instead, the SSR package should import from `@qwik.dev/router`.
 *
...
export type { QPrefetchData } from '../../../qwik-router/src/runtime/src/service-worker/types';
