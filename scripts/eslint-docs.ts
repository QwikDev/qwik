...
// Function to extract frontmatter from existing file
function extractFrontmatter(filePath: string): string[] {
  ...
  // Extract all frontmatter content until the closing ---
...
// Extract frontmatter from existing file if it exists
const frontmatterLines = extractFrontmatter(outputPathMdx);
if (frontmatterLines.length > 0) {
  mdx.push(...frontmatterLines);
}
