 ...
 *
 * This build mainly is re-exports the jsx runtime functions provided by the core. Internally, the
 * core's JSX renderer is using the latest jsx transform, but Qwik provides both the legacy `h()`
 * jsx factory, and the `jsx()` runtime.
 *
