...
function pauseContainer(elmOrDoc) {
    ...
    script.textContent = JSON.stringify(data, undefined, '  ' );
 ...
 * @alpha
 */
const version = "0.0.18-dev20220421193600";
...
export { Host as H, useStore as a, componentQrl as c, jsx as j, pauseContainer as p, qrl as q, render as r, setPlatform as s, useLexicalScope as u };
