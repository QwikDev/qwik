...
//
// @public
export const Host: FunctionComponent<JSXInternal.HTMLAttributes | JSXInternal.SVGAttributes | Record<string, any>>;
...
//
// @public (undocumented)
function jsx(type: string | FunctionComponent, props: JSXInternal.SVGAttributes & JSXInternal.HTMLAttributes & Record<string, any> & {
...
export namespace JSXInternal {
    ...
    //
    // (undocumented)
    export interface DOMAttributes<Target extends EventTarget = EventTarget> extends JSXDOMEvents, JSXBase {
    }
    // (undocumented)
