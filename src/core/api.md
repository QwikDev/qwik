...
// Warning: (ae-forgotten-export) The symbol "MightPromise" needs to be exported by the entry point index.d.ts
//
// @public (undocumented)
export function qComponent<PROPS extends {}>(tagName: string, onMount: TypeOrQRL<(props: PROPS) => MightPromise<ReturnType<typeof onRender>>>): (props: PROPS) => JSXNode<PROPS>;

// @public (undocumented)
export function qComponent<PROPS extends {}>(onMount: TypeOrQRL<(props: PROPS) => MightPromise<ReturnType<typeof onRender>>>): (props: PROPS) => JSXNode<PROPS>;
