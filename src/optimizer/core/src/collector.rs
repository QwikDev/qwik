...
//         let mut local_decl: Vec<Id> = self.local_decl.into_iter().collect();
//         local_decl.sort();
//         local_decl
//     }
// }
...
//                 self.local_decl.insert(id!(ident.id));
//             }
...
//                                 self.local_decl.insert(id!(ident));
//                             } else {
//                                 self.local_decl.insert(id!(v.key));
//                             }
//                         }
...
//         self.local_decl.insert(id!(node.ident));
//         node.visit_children_with(self);
//     }
