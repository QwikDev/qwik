...
Welcome to the fabulous Qwikcity. Qwikcity is our official kit to build amazing sites:
...
- **The `src/layout` folder**: This is what brings form to your content. Different kinds of pages might need to be rendered by a different layout.
  This way, you can easily reuse the layout across different content. By default, the `src/layout/default` is used.
