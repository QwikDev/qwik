import { h, component, onRender$, $, useEvent, useStore } from '@builder.io/qwik';
      ...
      return (
        <div id="my-app" onDocument$:expensiveComputationDone={() => (state.running = false)}>
          ...
          <p>
            ...
            <a href="https://github.com/BuilderIO/partytown">Partytown</a> is{' '}
            {state.running ? (
          ...
          <ol>
            <li>
              ...
              thread to render this page. (<code>partytown.js</code> is used to execute things of
              main thread and not for rendering the application.)
            </li>
            <li>
            ...
            <li>
              Notice that Qwik automatically lazily-loaded and hydrated the component upon
              interaction without the developer having to code that behavior. (Lazy hydration is
              what gives even large apps instant on behavior.)
            </li>
            <li>
