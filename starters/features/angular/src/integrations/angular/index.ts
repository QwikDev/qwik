...
import { TableComponent, type TableUserData, type TableComponentProps } from './components/table/table.component';

export const MaterialSlider = qwikify$<SliderComponentProps>(SliderComponent, {eagerness: 'hover'});
