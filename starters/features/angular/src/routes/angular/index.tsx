...
import { MaterialSlider, MaterialButton, type ButtonComponentProps, MaterialTable, type TableUserData } from "~/integrations/angular";
...
export default component$(() => {
    ...
    return (
        <div>
            ...
            <MaterialButton color="accent" client:hover host:onClick$={() => {
              show.value = true;
            }}>
                Show table
            </MaterialButton>
